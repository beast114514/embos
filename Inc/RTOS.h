...
*/
int  OS_mutex_initialize     (void* mutex) OS_TEXT_SECTION_ATTRIBUTE(OS_mutex_initialize);
void OS_mutex_acquire        (void* mutex) OS_TEXT_SECTION_ATTRIBUTE(OS_mutex_acquire);
void OS_mutex_release        (void* mutex) OS_TEXT_SECTION_ATTRIBUTE(OS_mutex_release);
void OS_mutex_free           (void* mutex) OS_TEXT_SECTION_ATTRIBUTE(OS_mutex_free);
...
void OS_InitSysStackInfo(void) OS_TEXT_SECTION_ATTRIBUTE(OS_InitSysStackInfo);
