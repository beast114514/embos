...
//
    ...
    RTT_PRAGMA(data_alignment=SEGGER_RTT_CPU_CACHE_LINE_SIZE) SEGGER_RTT_CB _SEGGER_RTT;
    RTT_PRAGMA(data_alignment=SEGGER_RTT_CPU_CACHE_LINE_SIZE) static char   _acUpBuffer  [SEGGER_RTT__ROUND_UP_2_CACHE_LINE_SIZE(BUFFER_SIZE_UP)];
    RTT_PRAGMA(data_alignment=SEGGER_RTT_CPU_CACHE_LINE_SIZE) static char   _acDownBuffer[SEGGER_RTT__ROUND_UP_2_CACHE_LINE_SIZE(BUFFER_SIZE_DOWN)];
  #else
